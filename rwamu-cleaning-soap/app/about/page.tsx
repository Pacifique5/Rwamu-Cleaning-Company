        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              About <span className="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">Rwamu</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl italic text-blue-600 mb-4">"Let's keep our environment clean"</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Environmental Care</h3>
              <p className="text-gray-600">
